    ...
    return(
        <StyledFlexRow>
            <StyledFlexColumn className="basic-info-box basic-info-border">
                ...
                <span>장소 Place</span><span className="basic-value">{cafe.place.name}</span>
            </StyledFlexColumn>

            <StyledFlexColumn className="basic-info-box basic-info-border">
                <span>영업 시간 Hour</span><span className="basic-value">{cafe.metadata?.hour}</span>
                <span style={{position: "relative"}}>상태 Status <i className="material-icons help-icon">help_outline</i></span><span className="basic-value">{cafe.state}</span>
                <span>카페 등록 일자 Created At</span><span className="basic-value">{cafe.createdAt}</span>
            </StyledFlexColumn>

            <StyledFlexColumn className="basic-info-box">
                <span>이미지 수 Images</span><span className="basic-value">{cafe.image.count} <i className="material-icons">open_in_new</i> </span>
